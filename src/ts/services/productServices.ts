...
export const p6: Product = new Product(6,"Lunnefågel",4, 3, "En färgglad och charmerande sjöfågel som är känd för sitt karaktäristiska utseende och sitt vackra flyg. Med sin unika personlighet är lunnefågeln ett utmärkt val för de som älskar naturen och det marina livet.", 0,"/src/img/puffin.jpg","Kenya");
...
export const p8: Product = new Product(8,"Sköldpadda",8, 0.003, " En tålig och långlivad sköldpadda som är en populär favorit bland reptilälskare. Denna landsköldpadda är en perfekt för dem som vill ha ett sällskapsdjur som ger stillsamhet och lugn.", 0,"/src/img/tortoise.jpg","Kenya");
...
export const p16: Product = new Product(16,"Tvättbjörn",5, 0.085, "Intelligent, nyfiken och skicklig på att använda sina tassar för att manipulera föremål.", 0,"/src/img/raccoon.jpg","Kenya");
